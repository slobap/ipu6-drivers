...
__used __section("__versions") = {
	{ 0x39f38b63, "__devm_regmap_init_i2c" },
	{ 0xc901db87, "devm_nvmem_register" },
	...
	{ 0x691ca9e8, "v4l2_fwnode_endpoint_alloc_parse" },
	{ 0x10182b84, "fwnode_handle_put" },
	{ 0xdf64a9e7, "v4l2_fwnode_endpoint_free" },
...
MODULE_INFO(depends, "v4l2-fwnode,videodev,mc,v4l2-async");

MODULE_ALIAS("acpi*:INT3474:*");

MODULE_INFO(srcversion, "623F0EAE45BCCE5FB898C7A");
